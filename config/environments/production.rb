Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "cc3_#{Rails.env}"
  config.action_mailer.perform_caching = false

  # Configure ActionMailer per devise --- host needs to match actual host
  config.action_mailer.default_url_options = { host: 'climatecents3.herokuapp.com' }
  ...
  # Amazon S3 credentials for Paperclip
