...
partner = Partner.new(location_id: loc.id,
  ...
  description: "<p>In the early 1970’s, MEND — Meet Each Need with Dignity — opened its doors in an effort to transform the lives of the neediest residents of the Northeast San Fernando Valley – poor children and their struggling families</p>
    ...
    <p>Less than 6% of revenues go to overhead. Every other bit of support goes directly to programs that that provides emergency food, clothing, medical, vision and dental care, job skills training and job placement assistance, English as a Second Language classes, youth activities, and a Christmas program.</p>
    <p>Although MEND is dedicated to relieving the effects of poverty, its underlying mission is to provide the means and the path to self-sufficiency: to &#8216;break the bonds of poverty.&#8217; MEND provides the basic human needs vital to day-to-day survival as well as education, training, opportunities, and support essential to reducing and ultimately eliminating reliance on public and private assistance. Most importantly, MEND provides these services in a manner that maintains the dignity and self-esteem of recipients.</p>
    <p>Each month, more than 16,600 hours are donated by volunteers from a broad range of backgrounds and income levels; all joining together to act as people helping people. Each person plays a vital role in meeting the mission of MEND. From the distribution of food, clothing to assistance in job training and placement, volunteers give MEND life.</p>
    <h3>Grow Together</h3>
    <p>More than 75% of all MEND clients have household incomes of less than $10,000 per year, and that 48% suffer from a diet-related illness. In the poor neighborhoods in and aroud Pacoima, like communities across the country, growing numbers of people are suffering from their lack of access to healthy food they can afford. As a result, diet-related illness are skyrocketing.</p>
    <p>Grow Together tackles both these problems by empowering immigrant families to make use of their unique knowledge and skills. Though many of the families served by the program grew up in farming communities, they’ve lacked the resources here to start home gardens of their own.</p>
    <p>Launched in the spring of 2013, Grow Together is a community initiative created to empower disadvantaged families in the northeast San Fernando Valley to work towards self-reliance and greater food security. It promote good health to its participants through access to fresh produce, the exercise involved in gardening, and educational workshops on topics like cooking, canning, and nutrition.</p>
    <p>Participating families are also provided with fruit trees and tree care workshops. Grow Together families are given the opportunity to engage in an activity where they can come together and give back to their communities by sharing what they learned and harvested. Tomatoes, melons, squash, cucumbers, peppers, kale, chard, broccoli, cabbage, cauliflower, green beans, cilantro, basil, rosemary and thyme are just some of the most common crops.</p>
    <p>Families use the people and climate-friendly techniques out there —
     — Organic — no herbicides, pesticides, insecticides and petroleum-based fertilizers — Drip irrigation and straw as crop cover to reduce water use — Composting — turning plant waste into nourishment for the next generation of plants, not filling landfills — No Till — Companion Planting – putting plants together whose needs and by-products complement each other. So far the project has built home gardens for 163 families, and provided the training and support to ensure their success.</p>
    <p>To combat hunger, build home gardens, and promote healthy and sustainable lifestyles, the MEND Grow Together Project has partnered with community organizations and individuals. In building all 163 home gardens, the MEND Grow Together Project works with the Sylmar High School Horticulture Department to provide participating families with seedlings. It is currently working with Master Gardeners and Master Food Preservers who provide the training for Grow Together families. More than 150 volunteers have dedicated their time to this program so far and in 2015 alone, volunteers contributed nearly 1,700 hours of service.</p>",
  volunteer: "<p>One of the reasons that MEND is amazing is because they are powered by volunteers. Like Climate Cents, they use their staff to manage an enthusiastic and talented group of every day people so their impact is multiplied many times over.</p>

<p>There are endless opportunities to help out their work of supporting low-income families in the most dignified way possible. We suggest getting started with their Grow Together and Food Justice program. You can help out as a gardener, someone who helps sort fresh produce for the food pantry, and more.</p>",
  news: "{partner.name} News")
partner.save
